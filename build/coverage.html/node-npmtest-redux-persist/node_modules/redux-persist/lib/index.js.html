...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-redux-persist/node_modules/redux-persist/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-redux-persist/node_modules/redux-persist/lib/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-redux-persist/node_modules/redux-persist/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
// @TODO remove in v5
var deprecated = <span class="fstat-no" title="function not covered" >function deprecated(cb, cb2, cb3) {</span>
<span class="cstat-no" title="statement not covered" >  console.error('redux-persist: this method of importing storages has been removed. instead use `import { asyncLocalStorage } from "redux-persist/storages"`');</span>
...
<span class="cstat-no" title="statement not covered" >  if (typeof cb2 === 'function') <span class="cstat-no" title="statement not covered" >cb2();</span></span>
<span class="cstat-no" title="statement not covered" >  if (typeof cb3 === 'function') <span class="cstat-no" title="statement not covered" >cb3();</span></span>
};
